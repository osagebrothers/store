...
// Projection-box Z must be > local shell curvature within the decal footprint
// (otherwise no triangles fall inside and nothing renders) but < shell thickness
// where mainCap doubles back, so it doesn't bleed onto the inside surface.
